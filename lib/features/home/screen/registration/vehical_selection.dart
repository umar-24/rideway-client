...
class VehicalSelection extends StatefulWidget {
  const VehicalSelection({super.key});

  @override
  State<VehicalSelection> createState() => _VehicalSelectionState();
}

class _VehicalSelectionState extends State<VehicalSelection> {
  @override
