...
class VehicalSelectionCtc extends StatefulWidget {
  const VehicalSelectionCtc({super.key});

  @override
  State<VehicalSelectionCtc> createState() => _VehicalSelectionCtcState();
}

class _VehicalSelectionCtcState extends State<VehicalSelectionCtc> {
  @override
